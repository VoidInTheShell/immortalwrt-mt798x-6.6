...
def validate_config():
    ...
    required = {'CONFIG_TARGET_mediatek_filogic_DEVICE_bananapi_bpi-r3-mini': 'y',
                ...
                'CONFIG_MODEMMANAGER_WITH_MBIM': 'y', 'CONFIG_MODEMMANAGER_WITH_QMI': 'y',
                'CONFIG_MODEMMANAGER_WITH_QRTR': 'y',
                'CONFIG_MODEMMANAGER_WITH_AT_COMMAND_VIA_DBUS': 'y',
                'CONFIG_LIBQMI_COLLECTION_FULL': 'y',
                'CONFIG_LIBQMI_WITH_MBIM_QMUX': 'y', 'CONFIG_LIBQMI_WITH_QRTR_GLIB': 'y',
                'CONFIG_PACKAGE_luci-proto-modemmanager': 'y',
                'CONFIG_PACKAGE_luci-proto-mbim': 'y', 'CONFIG_PACKAGE_luci-proto-qmi': 'y',
                'CONFIG_PACKAGE_luci-app-5gmodem': 'y',
                'CONFIG_PACKAGE_luci-i18n-5gmodem-zh-cn': 'y',
...
def validate_artifacts(stage_name, targets=(), output_dir=None):
    ...
    if stage_name == 'package-install':
        ...
        required = ['lib/modules/*/mtkhnat.ko*', 'lib/modules/*/mt_wifi.ko*',
                    ...
                    'usr/share/luci/menu.d/luci-app-5gmodem.json',
                    'usr/share/rpcd/acl.d/luci-app-5gmodem.json',
                    'usr/share/rpcd/acl.d/luci-app-5gmodem-api.json',
                    'www/luci-static/resources/view/modem5g/5gdetail.js',
                    'www/luci-static/resources/view/modem5g/5gdebug.js',
                    'www/luci-static/resources/view/modem5g/bandsui.js',
                    'www/luci-static/resources/view/modem5g/readsms.js',
                    'www/luci-static/resources/view/modem5g/sendussd.js',
                    'www/luci-static/resources/view/modem5g/sendat.js',
                    'usr/share/5gmodem/5gmodem.sh',
                    'usr/share/5gmodem/mkiface.sh',
                    'usr/share/5gmodem/collect.sh',
                    'etc/config/5gmodem',
